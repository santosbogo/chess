...
public class ClassicChessBoardGenerator implements BoardGenerator {
  ...
  private void generatePawns(
    ...
    for (char i = 'A'; i <= 'H'; i++) {
      pieces.put(
          new Coordinates(i, row), pieceGenerator.generatePiece(ChessPieceNames.PAWN, pieceColor));
    }
  }
  ...
  private void generateRooks(
    ...
    pieces.put(
        new Coordinates('A', row), pieceGenerator.generatePiece(ChessPieceNames.ROOK, pieceColor));
    pieces.put(
        new Coordinates('H', row), pieceGenerator.generatePiece(ChessPieceNames.ROOK, pieceColor));
  }
  ...
  private void generateKnights(
    ...
    int row = pieceColor.equals(PieceColor.WHITE) ? 1 : 8;
    pieces.put(
        new Coordinates('B', row),
        pieceGenerator.generatePiece(ChessPieceNames.KNIGHT, pieceColor));
    pieces.put(
        new Coordinates('G', row),
        pieceGenerator.generatePiece(ChessPieceNames.KNIGHT, pieceColor));
  }
  ...
  private void generateBishops(
    ...
    int row = pieceColor.equals(PieceColor.WHITE) ? 1 : 8;
    pieces.put(
        new Coordinates('C', row),
        pieceGenerator.generatePiece(ChessPieceNames.BISHOP, pieceColor));
    pieces.put(
        new Coordinates('F', row),
        pieceGenerator.generatePiece(ChessPieceNames.BISHOP, pieceColor));
  }
  ...
  private void generateKing(
    ...
    int row = pieceColor.equals(PieceColor.WHITE) ? 1 : 8;
    pieces.put(
        new Coordinates('E', row), pieceGenerator.generatePiece(ChessPieceNames.KING, pieceColor));
  }
}
