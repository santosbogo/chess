...
import edu.austral.dissis.chess.engine.generators.PieceGenerator;
import edu.austral.dissis.chess.engine.coordinates.Piece;
import edu.austral.dissis.chess.engine.validators.moveValidators.basicMovesValidators.*;
import edu.austral.dissis.chess.engine.validators.moveValidators.classicChessMoveValidators.CantLeaveTheKingThreatenedMoveValidator;
import edu.austral.dissis.chess.engine.validators.moveValidators.classicChessMoveValidators.JustForwardMoveValidator;
import edu.austral.dissis.chess.engine.validators.moveValidators.classicChessMoveValidators.diferentColorInTargetMoveValidator;
