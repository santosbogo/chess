...
import edu.austral.dissis.checkers.game.TestCheckers;
import edu.austral.dissis.checkers.game.TestCheckersBoardGenerator;
...
public class PersonalizedCheckersTests {
  ...
  public void testCheckmateBecauseEnemyDoesntHavePieces() {
    ...
    assertEquals(
        ...
        game.playTurn(new Coordinates('A', 1), new Coordinates('C', 3)).getStatus());
  }
  ...
  public void testStalemate() {
    ...
    assertEquals(
        ...
        game.playTurn(new Coordinates('F', 5), new Coordinates('G', 6)).getStatus());
  }
  ...
  public void testUndoPawnMovementStillBlackTurn() {
    ...
    assertEquals(
        ...
        game.playTurn(new Coordinates('B', 2), new Coordinates('C', 3)).getStatus());
  }
  ...
  public void testCrowningChecker() {
    ...
    assertEquals(
        CheckersPieceNames.KING,
        game.getBoard().getPieceAt(new Coordinates('H', 8)).getPieceName());
  }
}
