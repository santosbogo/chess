...
public class ClassicChessInvalidMovesTests {
  ...
  public void pawnInvalidMovesTest2() {
    ...
    assertEquals(
        ...
        game.playTurn(new Coordinates('A', 2), new Coordinates('A', 5)).getStatus());
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('A', 2), new Coordinates('B', 3)).getStatus());
  }
  ...
  public void rookInvalidMovesTest() {
    ...
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('A', 1), new Coordinates('B', 1)).getStatus());
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('A', 1), new Coordinates('A', 2)).getStatus());
  }
  ...
  public void knightInvalidMovesTest() {
    ...
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('B', 1), new Coordinates('B', 3)).getStatus());
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('B', 1), new Coordinates('C', 2)).getStatus());
  }
  ...
  public void bishopInvalidMovesTest() {
    ...
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('C', 1), new Coordinates('C', 3)).getStatus());
    assertEquals(
        StatusOptions.FAILURE,
        game.playTurn(new Coordinates('C', 1), new Coordinates('D', 2)).getStatus());
  }
}
